        ...
        <div class="rounded-[2rem] border border-white/10 bg-white/5 p-6 lg:p-8">
            <div class="flex flex-col gap-4 border-b border-white/10 pb-6 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <p class="mt-3 max-w-3xl text-slate-300">{{ __('admin.home_section_form_intro') }}</p>
                </div>
            ...
            <form method="POST" action="{{ $isEditing ? route('admin.home-sections.update', $section) : route('admin.home-sections.store') }}" enctype="multipart/form-data" class="mt-8 grid gap-8 xl:grid-cols-[minmax(0,1fr)_20rem]">
                @csrf
                @if ($isEditing)
                    @method('PUT')
                @endif
                ...
                <div class="space-y-8">
                    <div class="rounded-[1.75rem] border border-white/10 bg-slate-950/50 p-5">
                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            <div><label class="mb-2 block text-sm text-slate-300">{{ __('admin.base_section_title') }}</label><input type="text" name="title" value="{{ old('title', $section->title) }}" required class="w-full rounded-2xl border border-white/10 bg-slate-900 px-4 py-3 text-white"></div>
                    ...
                    <div class="space-y-5">
                        <div class="flex flex-col gap-4 rounded-[1.75rem] border border-white/10 bg-slate-950/50 p-5 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            <button type="button" id="add-item-button" class="rounded-2xl bg-amber-400 px-6 py-3 font-bold text-slate-950">{{ __('admin.add_card') }}</button>
                        </div>
                                ...
                                <div class="section-item-card rounded-[1.75rem] border border-white/10 bg-slate-900/70 p-5" data-item-card>
                                    ...
                                    <div class="item-body mt-5 space-y-6">
                                        <div class="grid gap-4 md:grid-cols-2">
                                            <div><label class="mb-2 block text-sm text-slate-300">{{ __('admin.base_item_title') }}</label><input type="text" name="items[{{ $index }}][title]" value="{{ $item['title'] ?? '' }}" data-name="title" required class="w-full rounded-2xl border border-white/10 bg-slate-950 px-4 py-3 text-white"></div>
