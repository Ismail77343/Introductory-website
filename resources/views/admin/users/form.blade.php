                ...
                <div class="space-y-6">
                    <div class="rounded-[1.75rem] border border-white/10 bg-slate-950/50 p-6">
                        <div class="grid gap-5 md:grid-cols-2">
                            ...
                            <div><label class="mb-2 block text-sm text-slate-300">{{ __('admin.password_confirmation') }}</label><input type="password" name="password_confirmation" class="w-full rounded-2xl border border-white/10 bg-slate-900 px-4 py-3 text-white"></div>
                        </div>
                        @if ($isEditing)
